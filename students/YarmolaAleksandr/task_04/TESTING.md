...
- ✅ Метрики `app23_*` экспортируются успешно
...
### 2. Триггер алерта HighLatencyP95 (p95 > 200ms)
...
### 3. Триггер алерта HighErrorRate5xx (5xx > 1%)
...
- [ ] Метрики app23_* доступны на /metrics
...
- **Alert условие:** 5xx > 1% за 5 минут

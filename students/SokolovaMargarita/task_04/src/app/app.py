...
Вариант 19: prefix=app19_, SLO=99.0%, p95≤400ms, Alert: 5xx>3% за 10м
"""
...
# Префикс метрик согласно варианту 19
METRICS_PREFIX = "app19_"
...
# Метаданные студента
STUDENT_ID = os.getenv('STUDENT_ID', '220024')
STUDENT_GROUP = os.getenv('STUDENT_GROUP', 'АС-63')
VARIANT = os.getenv('VARIANT', '19')
...
def slow_endpoint():
    ...
    # Задержка 400-600ms (превышает SLO 400ms)
...
def index():
    ...
    return jsonify({
        ...
        'slo': {
            'availability': '99.0%',
            'p95_latency': '≤400ms',
            'error_rate': '5xx>3% triggers alert'
        },
        'endpoints': {
            'health': '/health',
            'data': '/api/data',

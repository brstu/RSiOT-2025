...
Создан namespace `state-as64-220053-v41` с метаданными студента в labels:

```yaml
apiVersion: v1
kind: Namespace
metadata:
  name: state-as64-220053-v53
  labels:
...
```bash
kubectl get statefulset -n state-as64-220053-v53
kubectl get pvc -n state-as64-220053-v53
kubectl get pods -n state-as64-220053-v53
```
...
```bash
kubectl exec -it db-as64-220053-v41-0 -n state-as64-220053-v53 -- psql -U postgres -d testdb
```
...
```bash
kubectl delete pod db-as64-220053-v41-0 -n state-as64-220053-v53
```
...
```bash
kubectl get cronjob -n state-as64-220053-v53
```

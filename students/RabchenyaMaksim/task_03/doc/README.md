...
| **ФИО** | Рабченя Максим |
| **Группа** | as-64 |
| **№ студенческого (StudentID)** | <YOUR_STUDENT_ID> |
...
Пример файла: `db-202512081500.sql`
...
```powershell
cd students/RabchenyaMaksim/task_03/src

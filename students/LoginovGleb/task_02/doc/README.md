...
#### Применение манифестов Minikube
...
10. 🆕 **Добавлен startup probe** для более надежного запуска контейнеров и оптимизированы параметры всех probes.
...
**Освоенные инструменты:** Docker, kubectl, Kubernetes (Deployment, Service, Ingress, ConfigMap, Secret, PVC, Probes), Kustomize (base + overlays), Helm, Kind, Minikube, Make, Bash scripting.

...
console.log(`STU_ID: ${process.env.STU_ID || 'undefined'}`);
console.log(`STU_GROUP: ${process.env.STU_GROUP || 'undefined'}`);
console.log(`STU_VARIANT: ${process.env.STU_VARIANT || 'undefined'}`);
...
app.get("/", (req, res) => {
  res.send("<h1>Добро пожаловать! V19</h1><p>Сервер работает через Docker Compose </p>");
});

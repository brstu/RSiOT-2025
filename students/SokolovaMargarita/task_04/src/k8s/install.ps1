...
# Variant 19: prefix=app19_, SLO=99.0%, p95≤400ms, Alert: 5xx>3% за 10м

Write-Host "============================================" -ForegroundColor Cyan
Write-Host "Lab 04: Observability and Metrics" -ForegroundColor Cyan
Write-Host "Student: Соколова Маргарита Александровна" -ForegroundColor Cyan
Write-Host "Group: АС-63, Variant: 19" -ForegroundColor Cyan
...
Write-Host "============================================" -ForegroundColor Cyan
Write-Host "Variant 19 Configuration" -ForegroundColor Cyan
Write-Host "============================================" -ForegroundColor Cyan
Write-Host "Metrics prefix: app19_" -ForegroundColor White
Write-Host "SLO Availability: 99.0%" -ForegroundColor White
Write-Host "SLO p95 Latency: ≤400ms" -ForegroundColor White
Write-Host "Alert: 5xx errors >3% for 10m`n" -ForegroundColor White

Write-Host "Alerts:" -ForegroundColor Yellow
Write-Host "  1. LowAvailability - triggers if availability < 99.0%" -ForegroundColor White
Write-Host "  2. HighErrorRate5xx - triggers if 5xx errors > 3% for 10m" -ForegroundColor White
Write-Host "  3. HighLatencyP95 - triggers if p95 latency > 400ms for 10m`n" -ForegroundColor White
